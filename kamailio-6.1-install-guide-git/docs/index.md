# Kamailio v6.1 - Install Guide #

**Guide to install Kamailio SIP Server v6.1 (stable) from Git repository.**
...
server 6.1.x version using the sources downloaded from GIT repository -
...
*This document focuses on Kamailio v6.1.x series with MySQL/MariaDB support, using a Debian unstable system.*
...
```Shell
  ...
  mkdir -p /usr/local/src/kamailio-6.1
  cd /usr/local/src/kamailio-6.1
...
The following packages are required before proceeding to the next steps.
  ...
  * if you want to enable more modules, some of them require extra libraries:
    ...
    * __libpcre2__ - `apt-get install libpcre2-dev`
...
such as `app_sqlang` (archived), `phonenum` or `ndb_cassandra`.
...
**NOTE**: Starting with v6.0.0, Kamailio has support for CMake, see related tutorials
if you want to compile and install Kamailio using it:

  * [https://www.kamailio.org/wikidocs/tutorials/cmake/](https://www.kamailio.org/wikidocs/tutorials/cmake/)
...
You can browse [kamailio.cfg](https://github.com/kamailio/kamailio/blob/6.1/etc/kamailio.cfg)
...
This version of the document is in git repository at:

  * https://github.com/kamailio/kamailio-docs/kamailio-6.0-install-guide-git/
